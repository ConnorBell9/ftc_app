...
public class BlueLeftByrd extends AutoByrd {
	...
	public void runOpMode() throws InterruptedException {
		...
		if (!isStopRequested()) {
			 ...
			 */
            moveWithEncoders(26,DEFAULT_MOVE_SPEED,FORWARDS);
			...
			/* This just gets the robot ready for its next maneuver make sure here that it is putting its front towards the
